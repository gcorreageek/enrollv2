...
class EventController extends Controller
{
    ...
    public function exportRunners($prefix, Request $request)
    {
        ...
        if($request->has('format')){
            ...
            $csv->insertOne(['id', 'name_last', 'name_first', 'gender', 'dob', 'doc_type', 'doc_num', 'mail', 'telephone', 'mobile', 'country', 'state', 'province', 'city', 'track', 'enrolled', 'bib', 'code_id', 'code', 'transaction', 'category', 'size', 'nickname', 'time_goal', 'time_best', 'event', 'url', 'relative_type', 'relative_name', 'relative_phone', 'comment', 'created', 'updated']);
