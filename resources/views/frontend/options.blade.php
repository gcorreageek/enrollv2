...
@section("content")
    ...
    <div class="col-lg-6 col-lg-offset-3">
        ...
        {!! Form::open(['url' => $prefix . '/' . $engine->id . '/' . $track->id . '/' . $runner->id . '/persist_options']) !!}
        ...
        <div class="form-group">
            ...
            <p class="form-control-static text-justify">
                <small>IMPORTANTE: Los nombres cortos (apodos) solo admiten hasta 12 caracteres como máximo y serán
                    ...
                    limitado. El participante podrá elegir el nombre que desee siempre y cuando no resulte ofensivo a la
                    moral, al espíritu de competencia ni a ninguna marca comercial de las empresas organizadoras y/o
                    patrocinadoras. La empresa organizadora se reserva el derecho de eliminar cualquier nombre corto que
        ...
        <p class="form-control-static text-justify">Se refiere al mejor tiempo que Ud. haya logrado obtener en cualquier
            otro evento similar, este tiempo deberá ser comprobable para ser considerado en la asignación de corrales de
            partida. Para este fin por favor proporcione tambien el nombre del evento donde logro obtenerlo y la URL de
